...
export const API_ROUTES: ApiRoute[] = [
  ...
  { method: 'GET', path: '/v1/admin/operators', purpose: 'List platform admins (super-admin)' },
  { method: 'POST', path: '/v1/admin/operators/invites', purpose: 'Invite a platform admin' },
  { method: 'DELETE', path: '/v1/admin/operators/:id', purpose: 'Remove a platform admin' },
